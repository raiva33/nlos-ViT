...
class Rec_Transformer(nn.Module):
    def __init__(self, input_size=512, in_chans=1, encoder_embed_dims=[64, 128, 256, 512], num_heads=[1, 2, 4, 8], depths=[2, 2, 2, 2], sum_encoder_embed_dims=960, rec_channels=1, rec_size=256):  #Changed rec size to 512, original 256
