...
def ground_truth_render(xml_path, dir_purpose, f_name, obj_name):
    ...
    # Set the desired size for the cropped image
    crop_width = 256
    crop_height = 256

    # Crop the image
    cropped_image = crop_center(gray_image, crop_width, crop_height)

    #Save file as npy
    npy_file = "./datasets/{}/target/{}/{}.npy".format(dir_purpose,obj_name,f_name)
    print(cropped_image.shape)  
    np.save(npy_file, cropped_image)

    #Save as jpg to check if it is rendering correctly
    new_p = Image.fromarray(cropped_image)
...
def create_ground_truth(x,y,z,r,xlm_path,dir_purpose,f_name,obj_name,scale):
    ...
    text_obj="./obj/Z.obj"
    text_scale='scale value="1"'
    text_trans = 'translate x="0" y="0" z="0"'
    new_text_obj="./obj/{}.obj".format(obj_name)
    new_text_scale='scale value="{}"'.format(scale)
...
if __name__ == '__main__':
    ...
    xlm_path="./datasets/xml/base_old.xml"
    npy_file = ""
