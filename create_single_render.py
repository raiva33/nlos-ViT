...
import transient_to_albedo as tra
...
def render(x=0.0,y=0.0,z=0.5,obj="Z"):
    path = "/code/datasets/comparison_metrics/"
    yaml_file="/code/datasets/comparison_metrics/base1.yaml"
    print(path)
...
def reconstruct(hdf5_file,obj_name,f_name):
    ...
    # print(voxel.shape)
    # transient_tmp = voxel
    # transient = np.resize(transient_tmp, (x,x,t))
    ...
    # vol = nlos.transient_to_albedo(transient)
    ...
    npy_file = "/code/datasets/comparison_metrics/predictions/feature/reduced_render/{}/{}".format(obj_name, f_name)
    g=reduce_image(images)

    #Save npy file
    print(images.shape)  
    np.save(npy_file, g) #np.save(npy_file, images_t)
    print(os.listdir("/code/datasets/comparison_metrics/predictions/feature/reduced_render/{}/".format(obj_name)))
...
if __name__ == '__main__':
    ...
    print(os.listdir("/code/datasets/comparison_metrics"))
